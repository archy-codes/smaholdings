...
public class ProjectTestCase {
	...
	public void CRUDTestCase() {
		...
		// fetching the list in the table
		assertEquals("Something went wrong while fetching the  list of projects!", 5,
				projectDAO.listActiveProjects().size());

		// fetching list of active projects by category
		assertEquals("Something went wrong while fetching the  list of projects!", 4,
				projectDAO.listActiveProjectsByCategory(1).size());
		assertEquals("Something went wrong while fetching the  list of projects!", 1,
				projectDAO.listActiveProjectsByCategory(6).size());

		// fetching list of latest active projects
		assertEquals("Something went wrong while fetching the  list of projects!", 5,
				projectDAO.listLatestActiveProjects(5).size());
